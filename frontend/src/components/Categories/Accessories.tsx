...
function Accessories() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      const response = await fetch("/accessories.csv");
  ...
  return (
    <>
      <NavBar />
      <SearchBar />
      <h2 style={{ marginTop: "3rem" }}>Category: Accessories</h2>
      <div className="intro-container">
        <img
          src="/assets/category_accessory.png"
          alt="Accessory"
          style={{ width: "15%", height: "auto" }}
        />
        <p>
          Elevate your musical experience with our comprehensive selection of
          instrument accessories. Tailored for musicians seeking to optimize
          performance, maintain their instruments, or expand their capabilities,
          our range includes everything from strings, picks, and cables to
          stands, cases, and cleaning kits. Whether you play guitar, bass,
          drums, or keyboards, find the right accessories to match your
