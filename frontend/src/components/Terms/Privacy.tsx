...
function Privacy() {
  return (
    <>
      <NavBar />
      <div className="legalNav" style={{ justifyContent: "space-between" }}>
        <Link
          className="legalLink"
          to="/legal/terms-of-use"
          style={{ marginRight: "10px", color: "#FFFFFF" }}
        >
          <div className="md-footer_button_left md-icon">
      ...
      <div className="section-3" style={{ backgroundColor: "#000000" }}>
        <div className="tou-container">
          ...
          <h2 className="tou-subheader">Interpretation</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Definitions</h2>
          <p className="tou-p">For the purposes of this Privacy Policy:</p>
          <ul>
            <li>
              <p className="tou-p">
            ...
            <li>
              <p className="tou-p">
                <strong>Website</strong> refers to Pluck Your Heart String Music
                Co.
              </p>
            </li>
            <li>
          ...
          <ul>
            <li>
              <p className="tou-p">Email address</p>
            </li>
            <li>
              <p className="tou-p">First name and last name</p>
            </li>
            <li>
              <p className="tou-p">Phone number</p>
            </li>
            <li>
              <p className="tou-p">
            ...
            <li>
              <p className="tou-p">Usage Data</p>
            </li>
          </ul>
          ...
          <h2 className="tou-subheader">Tracking Technologies and Cookies</h2>
          <p className="tou-p">
          ...
          <ul>
            <li>
              ...
              <p className="tou-p">Type: Session Cookies</p>
              <p className="tou-p">Administered by: Us</p>
              <p className="tou-p">
            ...
            <li>
              ...
              <p className="tou-p">Type: Persistent Cookies</p>
              <p className="tou-p">Administered by: Us</p>
              <p className="tou-p">
          ...
          <h2 className="tou-subheader">Use of Your Personal Data</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Retention of Your Personal Data</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Transfer of Your Personal Data</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Security of Your Personal Data</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Children&#x27;s Privacy</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Links to Other Websites</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Changes to this Privacy Policy</h2>
          <p className="tou-p">
          ...
          <h2 className="tou-subheader">Contact Us</h2>
          <p className="tou-p">
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ul>
            <li>By email: pluckyourheartstringmusic@gmail.com</li>
          </ul>
        </div>
      </div>
      <Footer />
