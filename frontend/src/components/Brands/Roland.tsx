...
function Roland() {
  ...
  return (
    <>
      <NavBar />
      <SearchBar />
      <h2 style={{ marginTop: "3rem" }}>Roland</h2>
      <div className="intro-container">
        <img
          src="/assets/roland.png"
          alt="Roland Logo"
          style={{ height: "2rem", width: "auto", filter: "invert(100%)" }}
        />
        <p>
          A pioneer in electronic instruments, Roland produces innovative and
          quality digital pianos, synthesizers, and electronic drums that offer
          superior sound and performance for all musicians.
        </p>
      </div>
