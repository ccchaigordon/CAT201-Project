...
function Ibanez() {
  ...
  return (
    <>
      <NavBar />
      <SearchBar />
      <h2 style={{ marginTop: "3rem" }}>Ibanez</h2>
      <div className="intro-container">
        <img
          src="/assets/ibanez.png"
          alt="Ibanez Logo"
          style={{ height: "8rem", width: "auto", filter: "invert(100%)" }}
        />
        <p>
          One of the first Japanese musical instrument companies to gain a
          significant foothold in import guitar sales in the United States and
          Europe, as well as the first brand of guitars to mass-produce the
          seven-string guitar and eight-string guitar. The company has an
          impressive lineup of products ranging from instruments to pedals and
          accessories, and have recently raised standards and eyebrows with the
          new AZ Series, which Josh Smith described as the best superstrat he's
