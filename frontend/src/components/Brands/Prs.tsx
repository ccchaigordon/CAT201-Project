...
function PRS() {
  ...
  return (
    <>
      <NavBar />
      <SearchBar />
      <h2 style={{ marginTop: "3rem" }}>PRS</h2>
      <div className="intro-container">
        <img
          src="/assets/prs.png"
          alt="PRS Logo"
          style={{ height: "12rem", width: "auto", filter: "invert(100%)" }}
        />
        <p>
          Experience the excellence of PRS guitars, renowned for their
          exceptional craftsmanship, attention to detail, and unparalleled sound
          quality. Founded by master luthier Paul Reed Smith, PRS has been a
          leading name in the guitar industry since 1985, delivering instruments
          that inspire artists across all genres.
        </p>
      </div>
