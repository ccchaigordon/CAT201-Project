...
function Focusrite() {
  ...
  return (
    <>
      <NavBar />
      <SearchBar />
      <h2 style={{ marginTop: "3rem" }}>Focusrite</h2>
      <div className="intro-container">
        <img
          src="/assets/focusrite.png"
          alt="Focusrite Logo"
          style={{ height: "2.5rem", width: "auto", filter: "invert(100%)" }}
        />
        <p>
          Manufacturer of audio interfaces and various other products for audio
          recording, striving to help musicians achieve the highest quality of
          music production. Founded in 1985 by the legendary Rupert Neve,
          Focusrite products like the Scarlett 2ir and the Octopre are used by
          audio professionals and amateur musicians alike.
        </p>
      </div>
