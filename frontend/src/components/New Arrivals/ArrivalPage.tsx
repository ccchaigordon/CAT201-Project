    ...
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:8083/backend/getWhatsNewProduct"
        );
        if (!response.ok) {
      ...
      <div className="deals-section">
        ...
        <div className="arrival-banner">
          ...
          <div className="banner-info">
            ...
            <p style={{ margin: "0" }}>
              Fresh off the shelves, our latest collection of musical
              instruments and accessories is here! Explore cutting-edge guitars,
              keyboards, drums, and more—designed to elevate your performance
              and ignite your creativity. Shop now and be the first to
