...
@WebServlet("/getWhatsNewProduct")
public class GETWHATSNEWPRODUCT extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String whatsnew_csvfile = "NEWARRIVALS.csv";
        ...
        List<Product> products = Product.readProductsFromCSV(whatsnew_csvfile);
