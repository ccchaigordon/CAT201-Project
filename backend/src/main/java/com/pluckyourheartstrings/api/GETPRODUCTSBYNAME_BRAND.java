...
@WebServlet("/getProductsByNameBrand")
public class GETPRODUCTSBYNAME_BRAND extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> products = Product.getProductByName_Brand(query, guitar_csvfile, bass_csvfile, drum_csvfile, keyboard_csvfile, accessories_csvfile);
