...
public class User {
    ...
    public User(String id, String name, String email, String pw, String address, String phoneNum){
        this.userID = id;
        this.name = name;
        this.email = email;
        this.password = pw;
    ...
    //update profile
    public static boolean updateProfile(String userID, String newName, String newEmail, String newPassword, String newAddress, String newPhoneNum){
        String csvFile = "USER.csv";
